...
\NewDocumentCommand{\aplot}{mmmmmmmm}{%
	\intertext{\begin{center}\begin{adjustbox}{max width = #1\linewidth}\begin{pspicture}(#2, #3)(#4, #5)
		\psaxes[showorigin = false]{<->}(0, 0)(#2, #3)(#4, #5)[#6, 0][#7, 0]
		#8
	\end{pspicture}\end{adjustbox}\end{center}}%
}

\NewDocumentCommand{\afinal}{m}{%
	\intertext{\begin{center}\fbox{\begin{varwidth}[c]{\linewidth}
		#1
